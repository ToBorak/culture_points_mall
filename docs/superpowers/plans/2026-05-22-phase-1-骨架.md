...
>
> 关联文档：[总路线图](2026-05-22-总路线图.md) · [设计文档](../specs/2026-05-22-文化官-动漫风钉钉应用-design.md)
...
export function HomePage() {
  return (
    <main className="min-h-screen bg-paper text-ink p-4 font-kuaile">
      <h1 className="text-3xl font-qingke">文化官</h1>
...
- [ ] **步骤 3-7：复制 H5 的 tsconfig / index.html / main.tsx / App.tsx，对照修改 title 为「文化官 · 管理后台」**
